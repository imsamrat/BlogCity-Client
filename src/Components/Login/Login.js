                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <div className="flex items-center">
                                    ...
                                    <p>Or</p>
                                    <button className="block w-full bg-yellow-400 hover:bg-yellow-300 p-4 rounded text-yellow-900 hover:text-yellow-800 transition duration-300"> <FontAwesomeIcon className="text-3xl" icon={faGoogle} /> Login with Google</button>
                </form>
                            </div>
                        </div>
                        );
